return {
    ...
    [0x00B]="Dodongo",
    [0x00C]="Keese",
    [0x00D]="?tfcw", -- seen: field, clock town entrance facing woodfall
    [0x00E]="Collectables",
    [0x00F]="Temp. Detail", -- arrows, steam, flames...
    [0x010]="Tatl",
    [0x011]="Cucco",
    [0x012]="Tektite",
    [0x014]="Peahat",
    ...
    [0x016]="Bug",
    [0x017]="Fish",
    [0x018]="Blackness", -- perhaps used for fading/blocking vision
    [0x019]="Dinofols",
    [0x01A]="Post with Cloth",
    ...
    [0x157]="Smoke",
    [0x158]="?lc", -- seen: lens climb, middle sht room
    [0x159]="Kafei",
    [0x15A]="? Loading Zone Thing", -- seen: everywhere
    [0x15B]="Bad bat",
    [0x15C]="?",
    [0x15D]="?",
    [0x15E]="Stone platform",
    [0x15F]="Fancy explosion",
    [0x160]="? Statue Spawning Effect (Camera Focus)",
    [0x161]="?",
    [0x162]="Fire Barrier",
    [0x163]="?",
    [0x164]="Boe",
    ...
    [0x1D4]="Snowy Tree",
    [0x1D5]="Mailman",
    [0x1D6]="Song Wall in Field",
    [0x1D7]="?",
    [0x1D8]="?sht4", -- goron roll spot?
    ...
    [0x1F4]="? Spiderweb",
    [0x1F5]="Zora egg",
    [0x1F6]="Blacksmith", -- "Zubora"
    [0x1F7]="Darmani (Grave)", -- Darmani
    [0x1F8]="Dojo practice log",
    [0x1F9]="Small Snowball",
    [0x1FA]="Darmani",
    [0x1FB]="Darmani's Gravestone",
    [0x1FC]="Deku Princess",
    [0x1FD]="Giant Goron (Wind)",
    [0x1FE]="Hot spring water",
    [0x1FF]="Blacksmith's Assistant", -- "Gabora"
    [0x200]="?",
    [0x201]="Goron baby",
    [0x202]="Anju",
    [0x204]="Giant bee",
    ...
    [0x263]="?",
    [0x264]="? Sakon's bag",
    [0x265]="Clock Town Props", -- not necessarily clock tower
    [0x266]="Circling Guay",
    [0x267]="Seagull",
    [0x268]="?",
    ...
    [0x274]="Deku Merchant",
    [0x275]="?sotct3", -- seen: guess
    [0x276]="Visiting Goron-goro",
    [0x277]="?",
    [0x278]="?",
    [0x279]="?",
    [0x27A]="?",
